...
class Scene5CarlSims(Scene):
    def construct(self):
        ...
        no_design = vn(
            "Không có thiết kế thủ công.  Chỉ có voxels và một utility function.",
        ...
        why_now = vn(
            "30 năm sau: nhiều compute hơn, nhiều dữ liệu hơn,\n"
            "công cụ toán học mới  →  ý tưởng này đang hồi sinh.",
            font_size=22, color=GRAY_LIGHT, slant=ITALIC,
            line_spacing=0.9,
        ...
        all_d = VGroup(section_label, ground, winner, revival_group, why_now)
