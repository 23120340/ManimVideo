...
class Scene7Outro(Scene):
    def construct(self):
        ...
        def make_column(names):
            col = VGroup(*[
                Text(n, font_size=18, color=GRAY_LIGHT) for n in names
            ])
        ...
        join = Text(
            "Support at:  patreon.com/trituetrongcothe",
        ...
        tagline = Text(
            "Exploring the mathematics of body design.",
