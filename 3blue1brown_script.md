...
|-----|---------|---------------------|
| 1 | Trí tuệ có thật sự nằm trong não không? | Sọc ngựa vằn KHÔNG phải để ngụy trang — nó để đuổi muỗi. |
...
**Visual:**
- Zoom vào một con muỗi đậu trên da ngựa vằn. Khi muỗi cố đậu lên vùng có sọc, nó *trượt đi* (mất định hướng do tương phản cao).
- Cú lật bài: cảnh nông dân sơn hoạ tiết sọc lên... bò.

**VO:**
> Câu trả lời thật: sọc để **đuổi muỗi**. Mắt kép của muỗi không xử lý được hoa văn tương phản cao — chúng không hạ cánh được. Có những trang trại sơn sọc lên bò để giảm bệnh do muỗi truyền, và nó hoạt động.
...
**Manim:**
- Cú "trượt" của muỗi trên sọc: dùng `UpdateFromAlphaFunc` với hàm noise để mô phỏng disorientation.
- Title card "ANSWER: MOSQUITOES" xuất hiện với `Write` animation, giữ 2 giây, fade.
...
- Patreon shoutout / link tutorial gốc.
